...
require_once($CFG->dirroot.'/local/lessonexport/lang/languages/english.php');
require_once($CFG->dirroot.'/local/lessonexport/lang/languages/arabic.php');
